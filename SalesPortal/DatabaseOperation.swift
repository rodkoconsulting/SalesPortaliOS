...
struct DbOperation {
    ...
    static func databaseInit() throws -> String? {
        ...
        let sqlOrderListHeader = "CREATE TABLE IF NOT EXISTS ORDER_LIST_HEADER(ORDER_NO STRING, ORDER_DATE STRING, SHIP_DATE STRING, ARR_DATE STRING, DIVISION_NO CHARACTER(2), CUSTOMER_NO STRING, STATUS STRING, HOLD STRING, COOP STRING, COMMENT STRING, PRIMARY KEY(ORDER_NO))"
